  ...
  return (
    <Card>
      <CardContent className="py-6 space-y-5">
        ...
        {isReady && (
          <div className="space-y-4">
            {/* Model info — entire row is clickable */}
            <Link href={`/projects/${projectId}/bim`}>
              <div className="flex items-center gap-3 p-4 bg-green-50 border border-green-200 rounded-lg cursor-pointer hover:bg-green-100 hover:border-green-300 transition-colors">
